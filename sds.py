...
def display():
    st.set_page_config(page_title="Schools Division Superintendent Dashboard", layout="wide")
    st.title(":bar_chart: Office of the Schools Division Superintendent ")
